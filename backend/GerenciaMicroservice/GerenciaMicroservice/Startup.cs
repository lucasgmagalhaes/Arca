...
namespace GerenciaMicroservice
{
    public class Startup
    {
        ...
        private void ConfigureDependencyInjection(IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(IAtendimentoService), typeof(AtendimentoService));
            services.AddScoped(typeof(IParceiroService), typeof(ParceiroService));
